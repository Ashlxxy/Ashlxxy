...
![Other Skills](https://skillicons.dev/icons?perline=10&i=html,css,bootstrap,sass,vite,astro,express,php,laravel,go,python,java,kotlin,redux,prisma,mysql,postgres,mongodb,firebase,supabase)

### Tools

![Tools](https://skillicons.dev/icons?perline=10&i=vscode,androidstudio,postman,github,git,notion,figma,vercel,netlify,cloudflare,npm,pnpm,bun,docker)

### Currently Learning

![Learning](https://skillicons.dev/icons?i=nextjs,typescript,threejs,cloudflare,docker,postgres)
